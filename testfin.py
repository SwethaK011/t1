...
openaiModels = os.getenv("OPENAI_MODEL")
portKey=os.getenv("PORT_KEY")
# Load Animation
...
print(user_id)
portkey_headers = createHeaders(api_key=portKey,provider="openai",metadata={"_user": a1, "session_id":user_id})
